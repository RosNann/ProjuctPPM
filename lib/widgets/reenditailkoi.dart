...
class ditailkoi extends StatefulWidget {
  const ditailkoi({super.key});

  @override
  State<ditailkoi> createState() => _ditailkoiState();
}

class _ditailkoiState extends State<ditailkoi> {
  @override
                      ...
                      children: [
                        SizedBox(
                          ...
                          InkWell(
                            ...
                            child: ClipRRect(
                                borderRadius: BorderRadius.circular(5),
                                child: Image.asset("${koi[i].image}",)
                            ),
                          ),
                        ),SizedBox(height: 5,),
                        Padding(
                          padding: const EdgeInsets.only(left: 8),
                          child: Text("${koi[i].title}",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w700,color: Colors.brown),),
                        ),
                      ],
                    ),
                    SizedBox(height: 4,),
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                  child: InkWell(
                                      onTap: () {
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=>newSlide(ind: i,)));
                                      },
                                      child: Text("${koi[i].buttom}",style: TextStyle(color: Colors.white),))),
                            ),
                          ),
                        ),
                        SizedBox(height: 4,),
                        Align(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Text("${koi[i].buttom1}",style: TextStyle(color: Colors.white,),),
                            ),
                          ),
                        )
                      ],
