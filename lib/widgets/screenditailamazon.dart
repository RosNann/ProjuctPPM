...
import 'package:projectaddpp/slide/productstabuck.dart';
import 'package:projectaddpp/widgets/test.dart';

import '../model/model.dart';
import '../slide/productamazon.dart';
import '../slide/purchase.dart';

class ditailamazon extends StatefulWidget {

  const ditailamazon({super.key});

  @override
  State<ditailamazon> createState() => _ditailamazonState();
}

class _ditailamazonState extends State<ditailamazon> {
  @override
                      ...
                      children: [
                        SizedBox(
                          ...
                          InkWell(
                            ...
                            child: ClipRRect(
                                borderRadius: BorderRadius.circular(5),
                                child: Image.asset("${amazon[i].image}",)
                            ),
                          ),
                        ),SizedBox(height: 5,),
                        Padding(
                          padding: const EdgeInsets.only(left: 8),
                          child: Text("${amazon[i].title}",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w700,color: Colors.brown),),
                        ),
                      ],
                    ),
                    SizedBox(height: 4,),
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                  child: InkWell(
                                      onTap: () {
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=>productamazon(ind: i,)));
                                      },
