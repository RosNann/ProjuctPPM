...
import '../slide/productstabuck.dart';
import '../slide/purchase.dart';

class ditailstarbuck extends StatefulWidget {
  const ditailstarbuck({super.key});

  @override
  State<ditailstarbuck> createState() => _ditailamazonState();
}

class _ditailamazonState extends State<ditailstarbuck> {
  @override
                      ...
                      children: [
                        SizedBox(
                          ...
                          InkWell(
                            ...
                            child: ClipRRect(
                                borderRadius: BorderRadius.circular(5),
                                child: Image.asset("${starbuck[i].image}",)
                            ),
                          ),
                        ),SizedBox(height: 5,),
                        Padding(
                          padding: const EdgeInsets.only(left: 8),
                          child: Text("${starbuck[i].title}",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w700,color: Colors.brown),),
                        ),
                      ],
                    ),
                    SizedBox(height: 4,),
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                  child: InkWell(
                                      onTap: () {
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=>productstarbuck(ind: i,)));
                                      },
