...
class productseller extends StatefulWidget {
  final ind;
  const productseller({super.key,this.ind});
              ...
              children: [
                ...
                Container(
                    ...
                    child: AnotherCarousel(images: [
                      AssetImage('${bestseller[widget.ind].image}'),
                      AssetImage('${bestseller[widget.ind].image1}'),
                      AssetImage('${bestseller[widget.ind].image2}'),
                    ],
                      dotSize: 7,
